...
interface ImmutableCollection<E> : Collection<E> {
    ...
    fun remove(element: E): ImmutableCollection<E>
    fun removeAll(elements: Collection<E>): ImmutableCollection<E>
    fun retainAll(elements: Collection<E>): ImmutableCollection<E>
}
